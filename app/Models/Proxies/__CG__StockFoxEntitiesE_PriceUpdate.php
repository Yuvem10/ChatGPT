 ...
 */
class E_PriceUpdate extends \StockFox\Entities\E_PriceUpdate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'price', 'updateDate', 'priceType', 'providerReference', 'productReference', 'provider', 'stockUpdates', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_PriceUpdate $proxy) {
