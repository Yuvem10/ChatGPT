 ...
 */
class E_ProductComposition extends \StockFox\Entities\E_ProductComposition implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'proportion', 'component', 'product', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_ProductComposition $proxy) {
    ...
    public function getProportion(): float
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProportion', []);

        return parent::getProportion();
    }
