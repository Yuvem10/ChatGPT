 ...
 */
class E_UserChannel extends \RFCore\Entities\E_UserChannel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'currentIndex', 'user', 'channel', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_UserChannel $proxy) {
    ...
    public function getCurrentIndex(): int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCurrentIndex', []);
