 ...
 */
class E_InventorySchedule extends \StockFox\Entities\E_InventorySchedule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'schedulePeriod', 'inventoryParameters', 'bypassProductRecount', 'location', 'lastInventory', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_InventorySchedule $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getSchedulePeriod(): string
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSchedulePeriod', []);

        return parent::getSchedulePeriod();
    }

    /**
     * {@inheritDoc}
     */
    public function getInventoryParameters(bool $asArray = false, bool $strict = false)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getInventoryParameters', [$asArray, $strict]);

        return parent::getInventoryParameters($asArray, $strict);
    }

    /**
     * {@inheritDoc}
     */
    public function setInventoryParameters(array $params)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInventoryParameters', [$params]);

        return parent::setInventoryParameters($params);
    }

    /**
     * {@inheritDoc}
     */
    public function isBypassProductRecount(): bool
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isBypassProductRecount', []);

        return parent::isBypassProductRecount();
    }
    ...
    public function getLastInventory()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLastInventory', []);

        return parent::getLastInventory();
    }
