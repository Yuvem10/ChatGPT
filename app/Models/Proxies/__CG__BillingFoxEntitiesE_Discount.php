 ...
 */
class E_Discount extends \BillingFox\Entities\E_Discount implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'discountType', 'label', 'amount', 'client', 'naturalPerson', 'product', 'productReference', 'productReferenceFamily', 'profile', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_Discount $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getProductReferenceFamily()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProductReferenceFamily', []);

        return parent::getProductReferenceFamily();
    }
