 ...
 */
class E_Contact extends \AdminFox\Entities\E_Contact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'position', 'origin', 'naturalPerson', 'company', 'site', 'user', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_Contact $proxy) {
