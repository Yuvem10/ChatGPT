 ...
 */
class E_PaymentDetails extends \BillingFox\Entities\E_PaymentDetails implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'paymentMeans', 'IBAN', 'BIC', 'client', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_PaymentDetails $proxy) {
    ...
    public function getPaymentMeans(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPaymentMeans', []);

        return parent::getPaymentMeans();
    }
