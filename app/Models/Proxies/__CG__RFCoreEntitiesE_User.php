...
class E_User extends \RFCore\Entities\E_User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'email', 'password', 'roles', 'securityToken', 'cookieToken', 'securityTokenExpiration', 'isActive', 'firstname', 'lastname', 'phone', 'CGUValidated', 'CGUValidatedDate', 'avatar', 'nullableProperties'];
        }
