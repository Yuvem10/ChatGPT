 ...
 */
class E_QuantityUnit extends \StockFox\Entities\E_QuantityUnit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'label', 'shortLabel', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_QuantityUnit $proxy) {
    ...
    public function getShortLabel(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getShortLabel', []);
