 ...
 */
class E_DiscountConnect extends \BillingFox\Entities\E_DiscountConnect implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'discount', 'client', 'naturalPerson', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_DiscountConnect $proxy) {
