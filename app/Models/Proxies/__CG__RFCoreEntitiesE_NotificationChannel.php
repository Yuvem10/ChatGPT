 ...
 */
class E_NotificationChannel extends \RFCore\Entities\E_NotificationChannel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'index', 'channel', 'notification', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_NotificationChannel $proxy) {
