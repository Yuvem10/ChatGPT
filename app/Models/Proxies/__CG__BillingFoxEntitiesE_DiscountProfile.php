 ...
 */
class E_DiscountProfile extends \BillingFox\Entities\E_DiscountProfile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'profileType', 'label', 'client', 'naturalPerson', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_DiscountProfile $proxy) {
