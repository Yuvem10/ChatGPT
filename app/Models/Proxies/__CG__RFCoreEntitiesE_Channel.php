 ...
 */
class E_Channel extends \RFCore\Entities\E_Channel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'key', 'label', 'firstIndex', 'lastIndex', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_Channel $proxy) {
    ...
    public function getFirstIndex(): int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFirstIndex', []);

        return parent::getFirstIndex();
    }
    ...
    public function getLastIndex(): int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLastIndex', []);

        return parent::getLastIndex();
    }
