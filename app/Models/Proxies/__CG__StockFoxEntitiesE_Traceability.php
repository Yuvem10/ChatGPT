 ...
 */
class E_Traceability extends \StockFox\Entities\E_Traceability implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'sourceProduct', 'finalProduct', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_Traceability $proxy) {
    ...
    public function getSourceProduct()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSourceProduct', []);

        return parent::getSourceProduct();
    }
    ...
    public function getFinalProduct()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFinalProduct', []);

        return parent::getFinalProduct();
    }
