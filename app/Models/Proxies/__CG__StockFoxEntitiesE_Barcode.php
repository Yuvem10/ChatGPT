 ...
 */
class E_Barcode extends \StockFox\Entities\E_Barcode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'barcode', 'barcodeType', 'productReference', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_Barcode $proxy) {
    ...
    public function getBarcodeType(): int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBarcodeType', []);
