 ...
 */
class E_ActivityAttachment extends \AdminFox\Entities\E_ActivityAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'fileName', 'fileType', 'path', 'GEDFile', 'activity', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_ActivityAttachment $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getGEDFile(): ?int
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGEDFile', []);

        return parent::getGEDFile();
    }
