...
class E_RFModule extends \RFCore\Entities\E_RFModule implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'description', 'version', 'releaseNote', 'RF_dependencies', 'RF_children', 'Project_dependencies', 'Project_children', 'nullableProperties'];
        }
     ...
     * {@inheritDoc}
     */
    public function setRFDependencies(\Doctrine\Common\Collections\ArrayCollection $RF_dependencies): void
    {
     ...
     * {@inheritDoc}
     */
    public function setRFChildren(\Doctrine\Common\Collections\ArrayCollection $RF_children): void
    {
     ...
     * {@inheritDoc}
     */
    public function setProjectDependencies(\Doctrine\Common\Collections\ArrayCollection $Project_dependencies): void
    {
     ...
     * {@inheritDoc}
     */
    public function setProjectChildren(\Doctrine\Common\Collections\ArrayCollection $Project_children): void
    {
