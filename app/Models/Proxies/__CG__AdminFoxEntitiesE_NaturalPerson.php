 ...
 */
class E_NaturalPerson extends \AdminFox\Entities\E_NaturalPerson implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'lastname', 'firstname', 'email', 'phone1', 'phone2', 'address1', 'address2', 'city', 'postalCode', 'country', 'gender', 'status', 'naturalPersonType', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_NaturalPerson $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getNaturalPersonType(): ?int
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNaturalPersonType', []);

        return parent::getNaturalPersonType();
    }
