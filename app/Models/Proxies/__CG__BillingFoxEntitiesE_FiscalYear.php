 ...
 */
class E_FiscalYear extends \BillingFox\Entities\E_FiscalYear implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'fiscalYearName', 'startDate', 'endDate', 'invoices', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_FiscalYear $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getFiscalYearName(): string
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFiscalYearName', []);

        return parent::getFiscalYearName();
    }
