 ...
 */
class E_ProductTime extends \StockFox\Entities\E_ProductTime implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'days', 'timeType', 'productReference', 'provider', 'nullableProperties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (E_ProductTime $proxy) {
