<div class="form-row vertical-divider">
	<div class="col-6">
		...
		<div class="form-group">
			<button id="updateBtn" onclick='updateSchema()' class="btn btn-primary btn-block">Mettre à jour le Schema</button>
		</div>
        </div>
	...
	<div class="col-6">
		...
		<div class="form-group form-inline">
			<div class="input-group">
				<div class="input-group-prepend">
					<div class="input-group-text bg-primary text-white">Format</div>
				</div>
		...
		<div class="form-group">
			<button class="btn btn-primary float-center btn-block" onclick="exportDatabase()">
				Exporter
			</button>
		</div>
    </div>
