    ...
    <form id="formEditAPI" accept-charset="utf-8">
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text bg-primary"> <i class="fas fa-at text-white"></i> </span>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text bg-primary"> <i class="fas fa-unlock text-white"></i> </span>
                    </div>
