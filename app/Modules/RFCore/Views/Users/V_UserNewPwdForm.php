	...
	<form id="formNewPwd" action="<?php echo site_url($action); ?>" method="post">
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input required name="newPwd[password]" class="<?php if (isset($errors['newPwd.password'])) echo "is-invalid";?> form-control" placeholder="******" type="password">
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input required name="newPwd[passwordConf]" class="<?php if (isset($errors['newPwd.passwordConf'])) echo "is-invalid";?> form-control" placeholder="******" type="password">
