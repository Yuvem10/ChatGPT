				...
				$.ajax({
					...
					success: function (response) {
						if (response['status'] === <?= SC_SUCCESS ?>) {
							...
							// retrieve the first element of the sessionList
							// display the first session or create a new one
